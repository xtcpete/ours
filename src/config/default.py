...
_CN.LOFTR.MATCH_COARSE.ITER_THR = 0.01
_CN.LOFTR.MATCH_COARSE.K = 0.5
_CN.LOFTR.MATCH_COARSE.DIST_THR = 200
_CN.LOFTR.MATCH_COARSE.DIST_WEIGHT = 1.2
_CN.LOFTR.MATCH_COARSE.ITER = 10
_CN.LOFTR.MATCH_COARSE.BORDER_RM = 2
_CN.LOFTR.MATCH_COARSE.EPIPOLAR = True
...
_CN.LOFTR.MATCH_COARSE.TRAIN_PAD_NUM_GT_MIN = 200 # advoid DDP deadlock
...
_CN.LOFTR.TRIPLET_WEIGHT = 0.5
_CN.LOFTR.LOSS.MARGIN = 2.0
