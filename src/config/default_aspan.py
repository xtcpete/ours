...
_CN.ASPAN.MATCH_COARSE.THR = 0.1
_CN.ASPAN.MATCH_COARSE.ITER_THR = 0.01
_CN.ASPAN.MATCH_COARSE.K = 0.5
_CN.ASPAN.MATCH_COARSE.DIST_THR = 200
_CN.ASPAN.MATCH_COARSE.DIST_WEIGHT = 1.2
_CN.ASPAN.MATCH_COARSE.ITER = 10
